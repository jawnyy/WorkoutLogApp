...
struct Workouts: Identifiable, Hashable {
    ...
    static func DefaultWorkouts() -> [Workouts] {
        return [
            ...
            Workouts(name: "Cable Curls", description: "Biceps"),
            Workouts(name: "Reverse Cable Curls", description: "Biceps"),
            Workouts(name: "Hammer Curls", description: "Brachialis"),
            Workouts(name: "Cable Hammer Curls", description: "Brachialis"),
            Workouts(name: "Preacher Hammer Curls", description: "Brachialis"),
            Workouts(name: "Crossbody Hammer Curls", description: "Brachialis"),
            ...
            Workouts(name: "Dumbbell Raise", description: "Shoulders"),
            Workouts(name: "Arnold Press", description: "Shoulders"),
            Workouts(name: "Cable Lateral Raise", description: "Shoulders"),
            Workouts(name: "Dumbbell Lateral Raise", description: "Shoulders"),
            Workouts(name: "Cable Face Pull", description: "Shoulders"),
            Workouts(name: "Archer Pulls", description: "Shoulders"),
            ...
            Workouts(name: "Incline Machine Bench Press", description: "Chest"),
            ...
            Workouts(name: "Decline Cable Chest Press", description: "Chest"),
            Workouts(name: "Decline Machine Chest Press", description: "Chest"),
            Workouts(name: "Seated Cable Row", description: "Upper Back"),
            Workouts(name: "Machine Row", description: "Upper Back"),
            Workouts(name: "Single Arm Machine Row", description: "Upper Back"),
            Workouts(name: "Dumbbell Deadlift", description: "Lower Back"),
            Workouts(name: "Back Extensions", description: "Lower Back"),
            Workouts(name: "Cable Lat Pull Down", description: "Lats"),
            Workouts(name: "Rope Lat Pull Down", description: "Lats"),
            ...
            Workouts(name: "Machine Twist Obliques", description: "Core"),
            Workouts(name: "Leg Extension", description: "Quads"),
            Workouts(name: "Leg Press", description: "Quads"),
            Workouts(name: "Hack Squat", description: "Quads"),
            Workouts(name: "Machine Hack Squat", description: "Quads"),
            Workouts(name: "Pendulum Squat", description: "Quads"),
            ...
            Workouts(name: "Seated Calf Raises", description: "Calves")]
    }
}
